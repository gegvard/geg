...
public:	//Workbook
	...
	UFUNCTION(BlueprintCallable, Category = "DirectExcel|Workbook")
		bool Reload(ExcelReloadStrategy reloadStrategy = ExcelReloadStrategy::ReloadWithOriginalTableHeaders);
	...
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Workbook")
		TMap<FName, FExcelTableHeader> GetTableHeaders()const;
public:
	UFUNCTION(BlueprintCallable, Category = "DirectExcel|Workbook", meta = (WorldContext = "WorldContextObject"))
		bool StartWatch(const UObject* WorldContextObject, FExcelWorkbookChangedDelegate onChanged, ExcelReloadStrategy reloadStrategy=ExcelReloadStrategy::ReloadWithOriginalTableHeaders, float rate = 1.f);
